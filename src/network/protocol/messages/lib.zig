...
pub const SubmitOrderMessage = @import("submitorder.zig").SubmitOrderMessage;
...
pub const Message = union(MessageTypes) {
    ...
    pub fn hintSerializedLen(self: Message) usize {
        return switch (self) {
            ...
            .submitorder => |m| m.hintSerializedLen(),
        };
    }
};
